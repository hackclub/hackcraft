...
export default function Home() {
  ...
  <div className="container" style={{backgroundImage: 'url("images/deepslate.png")', backgroundRepeat: 'repeat'}}>
    <div className="section" style={{backgroundColor: 'rgba(0, 0, 0, 0.6)', padding: '1rem 1rem 1rem 1rem'}}>
      ...
      <p>Now!</p>
      <h4>- Do I need to use the Minecraft Launcher to test out my mod?</h4>
      <p>You can launch Minecraft directly with fabric developement environement! No need to install any additional software.</p>
